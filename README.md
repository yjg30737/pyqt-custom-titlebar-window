...
* ```setSeparatedTitleBar(icon: QIcon = QIcon(), font: QFont = QFont('Arial', 16))``` to set title bar above the menu bar. You can set the font of title bar and icon at the same time. Note: This needs to be refined more.
